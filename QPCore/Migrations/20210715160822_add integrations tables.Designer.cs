...
namespace QPCore.Migrations
{
    ...
    [Migration("20210715160822_add integrations tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.CompositeWebElement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.Integration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.IntegrationSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.CompositeWebElement", b =>
                {
                    ...
                    b.HasOne("QPCore.Data.Enitites.CompositeWebElement", "Parent")
                        .WithMany("Childs")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.Integration", b =>
                {
                    b.HasOne("QPCore.Data.Enitites.IntegrationSource", "Source")
                    ...
                    b.HasOne("QPCore.Data.Enitites.OrgUser", "User")
                        .WithMany("Integrations")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.TestFlow", b =>
                {
                    b.HasOne("QPCore.Data.Enitites.TestFlowCategory", "Area")
                        .WithMany("TestFlows")
            ...
            modelBuilder.Entity("QPCore.Data.Enitites.WorkItemTestcaseAssoc", b =>
                {
                    b.HasOne("QPCore.Data.Enitites.TestFlow", "Testcase")
                        .WithMany("WorkItemTestcaseAssocs")
                        .HasForeignKey("TestcaseId")
                        .HasConstraintName("fk_testflow_workitemtestcaseassoc_testflow_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QPCore.Data.Enitites.WorkItem", "WorkItem")
                        .WithMany("WorkItemTestcaseAssocs")
