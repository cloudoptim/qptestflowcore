...
namespace QPCore.Model.Organizations
{
    public class OrganizationMessageList
    {
        ...
        public const string CAN_NOT_DELETE_ORGANIZATION = "There are some assiation between Organization and Applications or User. Please remove them before you do this action.";
    }
}
